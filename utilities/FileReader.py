...
class FileReader(object):
    ...
    def line_reader(self, encoding = "utf-8-sig"):
        """
        Runs a function on each row of the given file.
        Should add in a way of trying different encodings in case of decode failure
        """
        with codecs.open(self.file_path, encoding = encoding) as file:
            pass
